...
router.post('/register', (req,res) => {
    ...
    //save user@gmail.com | ajdkhdk...dsdfdasd....fsafsa...sdaa
...
router.post('/login', (req,res)=>{
    ...
    // compare it to the user just tried to login 
    // so what we can do, is again one way encrypt the password the user just 
    // entered 
